...
**Version:** 0.1
**Status:** Initial draft for review and design-option selection
**Build target:** Agent Foundry Lab
...
* **Technical demonstration:** Provide an inspectable, working example of context engineering, semantic retrieval, evaluation, bounded retries, privacy-conscious generation, telemetry, and feedback-driven improvement, built through Agent Foundry Lab.
...
They are integration partners, not components Agent Foundry Lab must build under this document.
...
| Area                     | Decision                                                                                                                        |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| Framework                | Agent Foundry Lab generates a Python LangGraph agent. No Python-to-JavaScript translation is required.                          |
...
Include a build record identifying what Agent Foundry Lab generated and any subsequent manual changes. Do not claim a fully automated build unless that record supports it.
